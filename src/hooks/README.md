...
> `useSyncManager.ts` now skips the full cloud backup read when the remote file timestamp is already acknowledged locally, and throttles repeated foreground resume checks for 30 seconds.
