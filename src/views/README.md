...
- Update 2026-07-29: `TimelineView.tsx` now supports a persistent schedule-and-todo split workspace with a 00:00-24:00 pinch-zoom timeline, default 08:00 viewport, a review stack that scrolls with the canvas, and a same-level read-only todo column controlled from the right screen edge.
