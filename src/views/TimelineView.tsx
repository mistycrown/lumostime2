                    ...
                    {completedTodosToday.length > 0 && (
                        <div className="relative pl-8 mt-6 animate-in slide-in-from-bottom-2 duration-500">
                            ...
                            <div className="absolute -left-[60px] top-0.5 w-[45px] text-right">
                                <span className="text-xs font-bold text-emerald-700 font-mono">Done</span>
                            </div>

                            {/* Timeline Dot */}
                            <div className="absolute -left-[5px] top-1.5 w-2.5 h-2.5 rounded-full bg-emerald-700 border-2 border-[#faf9f6] z-10" />
                            ...
                            <div className="space-y-2" style={{ paddingTop: '2px' }}>
                                {completedTodosToday.map(todo => {
                                    return (
                                        ...
                                        >
                                            <span className="text-xs text-stone-600 group-hover:text-stone-900 leading-tight">
                                                {todo.title}
                                            </span>
                                        </button>
                                    );
