...
export const TimelineView: React.FC<TimelineViewProps> = ({ logs, todos, scopes, onAddLog, onEditLog, onUpdateLog, categories, currentDate, onDateChange, onShowStats, onBatchAddLogs, onSync, isSyncing, todoCategories, onToast, startWeekOnSunday = false, autoLinkRules = [], minIdleTimeThreshold = 1, onQuickPunch, refreshKey = 0, activeSessions = [], dailyReview, onOpenDailyReview, templates = [], dailyReviewTime = '22:00', autoGenerateDailyReview = false, weeklyReviews = [], onOpenWeeklyReview, weeklyReviewTime = '0-2200', autoGenerateWeeklyReview = false, monthlyReviews = [], onOpenMonthlyReview, monthlyReviewTime = '0-2200', autoGenerateMonthlyReview = false, timelineGalleryMode = false }) => {
    ...
    const shouldShowReviewNode = useMemo(() => {
        ...
        // 5. 自动生成逻辑：如果应该显示节点 && 开关开启 && 没有回顾，则自动创建
        ...
        return shouldShow;
    }, [dailyReview, onOpenDailyReview, dayTimeline.length, currentDate, dailyReviewTime, autoGenerateDailyReview]);
