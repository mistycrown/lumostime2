...
const buildInput = (): ActivityReferenceMigrationInput => ({
  ...
  activeSessions: [{ id: 'session-1', activityId: 'old', categoryId: 'old-cat', activityName: 'Old', activityIcon: 'O', startTime: 1 }],
  ...
  achievementRules: [{ id: 'achievement-1', name: 'Rule', enabled: true, effectType: 'earn', targetType: 'activity', targetIds: ['old', 'new'] }],
