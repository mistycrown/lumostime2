 ...
 * @input Activity, Category, and Scope collections
...
export const isTodoCategoryArchived = (category: Pick<TodoCategory, 'isArchived'>): boolean => category.isArchived === true;
