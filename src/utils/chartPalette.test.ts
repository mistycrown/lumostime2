 ...
 * @updated 2026-09-21: Covers the adjusted final colors for the Morandi and Spring East sequences.
 */
...
describe('chart palettes', () => {
  ...
  it('uses the eight fish-snack palette sequences', () => {
    expect(CHART_PALETTES.slice(1).map((palette) => [palette.label, palette.colors])).toEqual([
      ...
      ['雾感莫兰迪', ['#A7B1B2', '#C9B8AF', '#8DA0CB', '#B7C4A7', '#D9A5A5', '#9E9E9E', '#6B7C93', '#8C9A92']],
      ['春日东方', ['#F6BDC0', '#A7D7C5', '#FDE68A', '#9BC1BC', '#E07A5F', '#81B29A', '#3D405B', '#D9B08C']],
