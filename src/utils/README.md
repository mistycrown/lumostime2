...
- `todoListDisplayUtils.ts`: [Active] - Formats compact inline symbol-based date suffixes like `(05.06)[05.09]` and applies the shared category-list ordering that keeps incomplete scheduled todos ahead of unscheduled and completed ones.
