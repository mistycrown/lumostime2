...
import { AIBackfillChatComposer } from './ai-chat/AIBackfillChatComposer';
  ...
  return (
    ...
    >
      ...
      >
        ...
        <AIBackfillChatComposer
          AI_CHAT_THEME={AI_CHAT_THEME}
          QUICK_ADD_BACKFILL_PREFIX={QUICK_ADD_BACKFILL_PREFIX}
          QUICK_ADD_NOTE_PREFIX={QUICK_ADD_NOTE_PREFIX}
          QUICK_ADD_TODO_PREFIX={QUICK_ADD_TODO_PREFIX}
          activeMonthlyReviewShortcutOptions={activeMonthlyReviewShortcutOptions}
          activePersona={activePersona}
          activeSession={activeSession}
          activeWeeklyReviewShortcutOptions={activeWeeklyReviewShortcutOptions}
          composerContainerClassName={composerContainerClassName}
          composerMenuRef={composerMenuRef}
          composerTextareaRef={composerTextareaRef}
          focusComposerAtEnd={focusComposerAtEnd}
          handleFillDailyNarrativeCommand={handleFillDailyNarrativeCommand}
          handleFillDailyNewspaperCommand={handleFillDailyNewspaperCommand}
