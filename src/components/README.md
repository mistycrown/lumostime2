...
- Update 2026-05-17: `TodoMonthView.tsx` now adds a month-view entry background color picker so users can replace the default ultra-light tint with one unified custom background color while keeping existing schedule-type marker lines and maybe-style dashed borders.
