...
const PRESET_STICKER_SETS: StickerSet[] = [
    ...
    },
    {
        ...
        isCustom: false,
        stickers: [
            { path: '/sticker/water2/01.png' },
            { path: '/sticker/water2/02.png' },
            { path: '/sticker/water2/03.png' },
            { path: '/sticker/water2/04.png' },
            { path: '/sticker/water2/05.png' },
            { path: '/sticker/water2/06.png' },
            { path: '/sticker/water2/07.png' },
            { path: '/sticker/water2/08.png' },
            { path: '/sticker/water2/09.png' },
            { path: '/sticker/water2/10.png' },
            { path: '/sticker/water2/11.png' },
            { path: '/sticker/water2/12.png' },
            { path: '/sticker/water2/13.png' },
            { path: '/sticker/water2/14.png' },
