...
class NavigationDecorationService {
    private decorations: NavigationDecorationOption[] = [
        ...
        // PNG 格式装饰
        { id: 'blue', name: '蓝色', url: '/dchh/blue.png', offsetY: '71px', offsetX: '66px', scale: 1, opacity: 0.6 },
        { id: 'boat', name: '小船', url: '/dchh/boat.png', offsetY: '46px', offsetX: '65px', scale: 1.5, opacity: 0.6 },
        { id: 'fly', name: '飞行', url: '/dchh/fly.png', offsetY: '56px', offsetX: '-135px', scale: 1.3, opacity: 0.6 },
        { id: 'light2', name: '灯光2', url: '/dchh/light2.png', offsetY: '72px', offsetX: '-130px', scale: 1.2, opacity: 0.6 },
        { id: 'pink', name: '粉色', url: '/dchh/pink.png', offsetY: '71px', offsetX: '15px', scale: 1, opacity: 0.6 },
        { id: 'purple', name: '紫色', url: '/dchh/purple.png', offsetY: '46px', offsetX: '74px', scale: 1.45, opacity: 0.6 },
        { id: 'rabbit', name: '兔子', url: '/dchh/rabbit.png', offsetY: '51px', offsetX: '80px', scale: 1.4, opacity: 0.6 },
        { id: 'red', name: '红色', url: '/dchh/red.png', offsetY: '80px', offsetX: '78px', scale: 0.87, opacity: 0.58 },
        { id: 'siyecao', name: '四叶草', url: '/dchh/siyecao.png', offsetY: '71px', offsetX: '45px', scale: 0.85, opacity: 0.63 },
        { id: 'songguo', name: '松果', url: '/dchh/songguo.png', offsetY: '51px', offsetX: '90px', scale: 1.3, opacity: 0.6 },
        { id: 'strawberry', name: '草莓', url: '/dchh/Strawberry.png', offsetY: '51px', offsetX: '75px', scale: 1.45, opacity: 0.6 },
        { id: 'sun', name: '太阳', url: '/dchh/sun.png', offsetY: '61px', offsetX: '80px', scale: 1.35, opacity: 0.75 },
        { id: 'ya', name: '芽', url: '/dchh/ya.png', offsetY: '21px', offsetX: '23px', scale: 1.95, opacity: 0.6 },
    ];
