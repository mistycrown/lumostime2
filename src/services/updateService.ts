 ...
 * @updated 2026-04-07: Bumped the shipped app version to 1.6.0 so desktop installers can upgrade past the accidental 1.5.0 build line.
 * 
...
export class UpdateService {
    ...
    private static CURRENT_VERSION = '1.6.0';
