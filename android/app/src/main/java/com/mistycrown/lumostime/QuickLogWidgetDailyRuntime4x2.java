...
/**
 * DAILY_RUNTIME 4x2 widget provider.
 */
public class QuickLogWidgetDailyRuntime4x2 extends AppWidgetProvider {
    public static void refreshAllAsync(Context context) {
        AppWidgetManager appWidgetManager = AppWidgetManager.getInstance(context);
        ComponentName componentName = new ComponentName(context, QuickLogWidgetDailyRuntime4x2.class);
    ...
    private static void updateWidgets(
        ...
        WidgetDailyRuntimeProviderSupport.updateWidgets(
                ...
                appWidgetManager,
                appWidgetIds,
                R.layout.widget_layout_daily_runtime_4x2,
                true,
                QuickLogWidgetDailyRuntime4x2.class
        );
    }
}
