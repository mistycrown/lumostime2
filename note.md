...
重写ai叙事默认的提示词，分别是：
图标	模板名称	适用周期	核心风格与用途
📜	赛博黄历	日	玄学预测：基于五行生克的宜忌推演
📅	每日简报	日	客观记录：零修辞、数据导向，关注核心达成与时间效能。
🧞‍♂️	伴侣日记	日	树洞整理：将碎片想法串联成连贯日记，提供温暖的心理支持与洞察。
📊	极简复盘	周、月	趋势分析：剥离单日细节，关注涵盖整个周期的总量积累与效能趋势。
🌟	哲学命题	全周期	概念升维：哲学家视角，捕捉核心张力，通过一个哲学概念提升叙事深度。
⚠️	严格导师	全周期	犀利鞭策：替代超我，冷眼审视漏洞，拒绝任何借口，给出最后通牒。
🍃	正念叙事	全周期	温柔疗愈：情绪外化技术，引导觉察当下，构建心灵栖息地。
🚀	成长教练	全周期	行为设计：基于福格行为模型 (B=MAP) 的长期主义复盘与行动规划。
🚩	苏维埃政委	全周期	革命战报：钢铁意志，使用辩证法进行严肃的政治批示。
